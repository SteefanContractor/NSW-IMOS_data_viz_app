...
# install R packages
RUN sudo R -e "install.packages(c('ncdf4','zoo','lubridate','readODS','plotly','shinydashboard','leaflet','raster','rgdal','leaflet.minicharts', 'htmltools', 'htmlwidgets','geosphere'))"
